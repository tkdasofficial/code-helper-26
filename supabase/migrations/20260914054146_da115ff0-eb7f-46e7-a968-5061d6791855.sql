-- cron-fallback-reviewed: 288 runs/day; scheduled posts are minute-precise (e.g. 9:00 AM) and each due workflow must render a video then publish it, so due schedules must be picked up within 5 minutes.
  ...
  PERFORM cron.schedule(
    ...
    format($cmd$
      SELECT net.http_post(
        url := 'https://project--efea8b00-3f99-421b-8d1c-1d9462eef54c-dev.app/api/public/workflows/scheduler',
