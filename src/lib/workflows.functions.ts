...
export const listWorkflows = createServerFn({ method: "GET", name: "listWorkflows" })
...
(listWorkflows as any).__name = "listWorkflows";

export const getWorkflow = createServerFn({ method: "POST", name: "getWorkflow" })
  .middleware([requireSupabaseAuth])
...
(getWorkflow as any).__name = "getWorkflow";
...
export const saveWorkflow = createServerFn({ method: "POST", name: "saveWorkflow" })
  .middleware([requireSupabaseAuth])
...
(saveWorkflow as any).__name = "saveWorkflow";

export const setWorkflowEnabled = createServerFn({ method: "POST", name: "setWorkflowEnabled" })
  .middleware([requireSupabaseAuth])
...
(setWorkflowEnabled as any).__name = "setWorkflowEnabled";

export const deleteWorkflow = createServerFn({ method: "POST", name: "deleteWorkflow" })
  .middleware([requireSupabaseAuth])
...
(deleteWorkflow as any).__name = "deleteWorkflow";
 ...
 */
export const runWorkflowNow = createServerFn({ method: "POST", name: "runWorkflowNow" })
  .middleware([requireSupabaseAuth])
  .inputValidator((input: { id: string }) => input)
  .handler(async ({ data, context }) => {
...
(runWorkflowNow as any).__name = "runWorkflowNow";
