 ...
 */
export const startVideoRender = createServerFn({ method: "POST", name: "startVideoRender" })
...
(startVideoRender as any).__name = "startVideoRender";
 ...
 */
export const getVideoPlaybackUrl = createServerFn({ method: "POST", name: "getVideoPlaybackUrl" })
  .middleware([requireSupabaseAuth])
...
(getVideoPlaybackUrl as any).__name = "getVideoPlaybackUrl";
