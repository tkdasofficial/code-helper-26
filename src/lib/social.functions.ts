...
export const getMetaConfig = createServerFn({ method: "GET", name: "getMetaConfig" }).handler(async () => {
  try {
...
(getMetaConfig as any).__name = "getMetaConfig";

/** Every social account the signed-in user has linked. */
export const listSocialConnections = createServerFn({ method: "GET", name: "listSocialConnections" })
...
(listSocialConnections as any).__name = "listSocialConnections";
 ...
 */
export const completeMetaConnection = createServerFn({ method: "POST", name: "completeMetaConnection" })
  .middleware([requireSupabaseAuth])
...
(completeMetaConnection as any).__name = "completeMetaConnection";

/** Removes a linked account. */
export const disconnectSocialAccount = createServerFn({ method: "POST", name: "disconnectSocialAccount" })
  .middleware([requireSupabaseAuth])
...
(disconnectSocialAccount as any).__name = "disconnectSocialAccount";
