...
export const enqueueJob = createServerFn({ method: "POST", name: "enqueueJob" })
...
(enqueueJob as any).__name = "enqueueJob";

/** The signed-in user's tasks, newest first, with fresh signed result URLs. */
export const listJobs = createServerFn({ method: "POST", name: "listJobs" })
  .middleware([requireSupabaseAuth])
...
(listJobs as any).__name = "listJobs";

export const cancelJob = createServerFn({ method: "POST", name: "cancelJob" })
  .middleware([requireSupabaseAuth])
...
(cancelJob as any).__name = "cancelJob";

/** Single task lookup used by the client while a task is running. */
export const getJob = createServerFn({ method: "POST", name: "getJob" })
  .middleware([requireSupabaseAuth])
  .inputValidator((input: { id: string }) => input)
