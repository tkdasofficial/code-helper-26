...
export const getYouTubeConfig = createServerFn({ method: "GET", name: "getYouTubeConfig" }).handler(async () => {
  try {
...
(getYouTubeConfig as any).__name = "getYouTubeConfig";

/** Exchanges the Google authorization code and stores the channel + refresh token. */
export const completeYouTubeConnection = createServerFn({ method: "POST", name: "completeYouTubeConnection" })
...
(completeYouTubeConnection as any).__name = "completeYouTubeConnection";
