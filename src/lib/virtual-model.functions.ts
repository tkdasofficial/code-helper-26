...
export const listVirtualModels = createServerFn({ method: "POST", name: "listVirtualModels" })
...
(listVirtualModels as any).__name = "listVirtualModels";

export const deleteVirtualModel = createServerFn({ method: "POST", name: "deleteVirtualModel" })
  .middleware([requireSupabaseAuth])
...
(deleteVirtualModel as any).__name = "deleteVirtualModel";
